...
data_map <- left_join(us, states, by = "name")

# Plot
ggplot(data_map) +
  geom_sf(aes(fill = pct_change_99_16)) +
    scale_fill_viridis_b() +
  labs(title = "Teacher Salary Percent Change by State",
...
### Description
Salary changes as documented by the department of labor statistics, documenting the changes in teacher salary 
